...
func NewAdminScheduleHandler(t *template.Template, cs train.ScheduleService) *AdminScheduleHandler {
	return &AdminScheduleHandler{temp1:t, scheduleSrv:cs}
}
...
func(ash *AdminScheduleHandler) AdminSchedules(w http.ResponseWriter, r *http.Request){
	...
	ash.temp1.ExecuteTemplate(w, "admin.sched.layout", schedules)
}
...
func(ash *AdminScheduleHandler) AdminSchedulesNew(w http.ResponseWriter, r *http.Request){
	if r.Method == http.MethodPost {
		...
		ash.temp1.ExecuteTemplate(w,"admin.sched.new.layout", nil)
		}
}
func(ash *AdminScheduleHandler) AdminSchedulesUpdate(w http.ResponseWriter, r *http.Request){
	if r.Method == http.MethodPost{
		...
		ash.temp1.ExecuteTemplate(w, "admin.sched.update.layout", sat)
